  ...
  return (
    <Box>
      ...
      <Grid container spacing={2.5}>
        ...
        {/* HSN Code (shown for all industries, especially important for pharmacy) */}
        <Grid item xs={12} sm={6}>
          <TextField
            label={t('itemsPage.form.hsnCode')}
            name="hsnCode"
            value={itemFormData.hsnCode || ''}
            onChange={handleChange}
            fullWidth
            variant="outlined"
            placeholder={isPharmacy ? 'e.g. 3004' : 'e.g. 6109'}
            sx={inputSx}
        ...
        {isPharmacy && (
          <>
            ...
            <Grid item xs={12} sm={6}>
              <TextField
                label={t('itemsPage.form.manufacturer')}
                name="manufacturer"
                value={itemFormData.manufacturer || ''}
                onChange={handleChange}
                fullWidth
                variant="outlined"
                placeholder={t('itemsPage.form.manufacturerPlaceholder')}
                sx={inputSx}
              />
            </Grid>
